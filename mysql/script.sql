...
INSERT INTO `a_likes_c` VALUES ('minh',1,'2018-04-29 22:25:29',1),('minh',2,'2018-04-29 22:25:29',-1),('nhuy',1,'2018-04-29 22:25:29',1),('nhuy',2,'2018-04-29 22:25:29',1),('xxx',1,'2018-04-29 23:38:34',1),('xxx',2,'2018-05-04 22:06:51',1);
...
CREATE TABLE `a_likes_r` (
  ...
  CONSTRAINT `a_cmt_id_like_r` FOREIGN KEY (`reply_id`) REFERENCES `reply` (`reply_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `a_likes_r` VALUES ('minh',1,'2018-04-29 18:11:19',-1),('nhuy',1,'2018-04-29 18:11:35',-1),('xxx',1,'2018-04-29 18:11:05',1);
...
INSERT INTO `account` VALUES ('minh',1,'onggiacheating','default.img','mình là minh béo','Minh Béo','2018-05-04 10:52:53'),('nhuy',2,'nhuy','default.img','Như Ý :)','nhuy','2018-05-04 16:14:58'),('onggia',1,'onggia','default.img',NULL,'onggia','2018-05-04 16:15:34'),('root',3,'root','default.img','đây là root nhé','SUPPER ADMIN','2018-05-04 10:24:37'),('xxx',1,'123456','default.img',NULL,'xxx','0000-00-00 00:00:00');
...
INSERT INTO `comment` VALUES (1,'2018-04-29 18:02:26','hihi'),(2,'2018-04-29 18:12:42','abcxyz'),(3,'2018-05-04 15:55:39','onggia');
...
INSERT INTO `comments` VALUES ('nhuy',11,1),('minh',12,2),('xxx',14,3);
...
INSERT INTO `p_contains_v` VALUES (1,11),(2,11),(3,11),(2,12),(1,13),(3,13),(1,14),(2,14);
...
INSERT INTO `playlist` VALUES (1,'Ông Già và Biển Cả',1,'2018-04-29 23:00:58','minh'),(2,'Old man',1,'2018-04-29 23:00:58','minh'),(3,'Dirty',1,'2018-04-29 23:00:58','xxx');
...
INSERT INTO `replies` VALUES ('minh',1,2),('nhuy',1,1),('nhuy',2,4),('xxx',2,3),('xxx',2,5);
...
INSERT INTO `reply` VALUES (1,'2018-05-04 21:44:00','sfsdds'),(2,'2018-04-29 18:09:36','onggia'),(3,'2018-04-29 23:26:38','sfdshhsdf'),(4,'2018-04-29 23:26:38','hihi'),(5,'2018-04-29 23:27:06','skfhshfs');
...
INSERT INTO `subscribes` VALUES ('nhuy','minh'),('onggia','minh'),('onggia','nhuy'),('nhuy','onggia'),('nhuy','xxx'),('onggia','xxx');
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='This is video table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `video` VALUES (11,'Ong gia',1000,'abc',1,'x','2018-04-29 17:32:48','xxx','2018-04-29 17:32:48'),(12,'Dirty Old Man',200,'XXX',1,':)','2018-04-29 17:44:08','minh','2018-04-29 17:44:08'),(13,'Ông già',1000,'ABC',1,NULL,'2018-04-29 22:48:22','minh','2018-04-29 22:48:22'),(14,'Dirty',2000,'abc',1,NULL,'2018-04-29 22:48:22','nhuy','2018-04-29 22:48:22');
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `Reply_Delete`(_username varchar(30), _cmtid int(11), _repid int(11)) RETURNS int(11)
begin
 		declare result text;
		if (NOT Comment_CheckExist(_repid) )
		then
			return 0;
		else
		begin
			select content
				from video as v, comments  cs, reply as r, replies as rs
				where 
							v.id = cs.video_id
						and cs.comment_id = rs.comment_id	
						and r.reply_id = rs.reply_id
						
						and rs.comment_id = _cmtid
						and r.reply_id = _repid
						and (rs.account_name = _username or v.upload_account = _username)
				into result;
             if (result is not null)
            then
            begin
...
begin
		...
		then
		begin
			select reply.reply_id, replies.comment_id,  name , profile_img, dtime, content
...
-- Dump completed on 2018-05-05 15:29:48
